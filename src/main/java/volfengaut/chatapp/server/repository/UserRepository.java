...
import volfengaut.chatapp.server.entity.chat_room.ChatRoom_;
import volfengaut.chatapp.server.entity.message.BanMessageEntity;
import volfengaut.chatapp.server.entity.message.BanMessageEntity_;
import volfengaut.chatapp.server.entity.message.ChatMessageEntity;
import volfengaut.chatapp.server.entity.message.ChatMessageEntity_;
import volfengaut.chatapp.server.entity.role.UserRole;
import volfengaut.chatapp.server.entity.role.UserRole_;
import volfengaut.chatapp.server.entity.user.User;
import volfengaut.chatapp.server.entity.user.User_;
...
public class UserRepository implements IUserRepository {
    ...
    public Collection<User> getChattersBannedFrom(ChatRoom room) {
        ...
        Join<BanMessageEntity, User> joinToUsers = root.join(BanMessageEntity_.RECIPIENT);
    ...
    public Collection<User> getChattersBannedBy(User user) {
        ...
        CriteriaQuery<User> criteriaQuery = criteriaBuilder.createQuery(User.class);
        Root<BanMessageEntity> root = criteriaQuery.from(BanMessageEntity.class);
        Join<BanMessageEntity, User> joinToRecipients = root.join(BanMessageEntity_.RECIPIENT);
